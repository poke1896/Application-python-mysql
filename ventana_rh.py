...
#codigo para el identificador master y llamado de funciones 
    def __init__(self, master=None):
        super().__init__(master,width=1837, height=610,background="black")
        self.master = master
        self.pack()
        self.create_widgets()
        self.llenarDatos()
...
# llena el grid con un insert 
    def llenarDatos(self):
        datos = self.conec.consulta_rh()
        for row in datos:
            self.grid.insert("",END,text=row[0],values=(row[1],row[2],row[3],row[4],row[5],row[6],row[7],row[8],row[9],row[10],row[11],row[12],row[13],row[14]), tags=('LOL'))
...
#activan los combobox mientras se van introduciendo los datos
    ...
    def create_widgets(self):
        ...
        frame3.place(x=392,y=0,width=1442, height=259)
        ...
        self.grid = ttk.Treeview(frame3, columns=("col1","col2","col3","col4","col5","col6","col7","col8","col9","col10","col11","col12","col13","col14",))        
        ...
        self.grid.column("col9",width=140, anchor=CENTER)    
        ...
        self.grid.heading("col6", text="Provincia", anchor=CENTER)
        self.grid.heading("col7", text="Canton", anchor=CENTER)
        self.grid.heading("col8", text="Distrito", anchor=CENTER)
        self.grid.heading("col9", text="correo", anchor=CENTER)
        self.grid.heading("col10", text="fecha de nacimiento", anchor=CENTER)
        self.grid.heading("col11", text="horas laboradas", anchor=CENTER)
        self.grid.heading("col12", text="salario", anchor=CENTER)
        self.grid.heading("col13", text="evaluacion", anchor=CENTER)
        self.grid.heading("col14", text="fecha de pago", anchor=CENTER)
